...
FILES = [
    ...
    'package.json',
    'CHANGELOG.md',
    'background-sw.js', 'background.js', 'game-api-bridge.js', 'server-storage.js', 'sidebar-inject.js',
    ...
    'dashboard.html', 'dashboard.css', 'nocturne.css', 'dashboard.js', 'common.js',
    'tabs/global.js', 'tabs/surveys.js', 'tabs/pirates.js', 'tabs/mining.js',
    'tabs/battles.js', 'tabs/debris.js', 'tabs/expeditions.js', 'tabs/wormholes.js', 'tabs/finder.js', 'tabs/asteroids.js', 'tabs/fleets.js', 'tabs/scouting.js', 'tabs/xeno.js', 'tabs/stations.js', 'tabs/market.js', 'tabs/market-history.js', 'tabs/techtree.js', 'tabs/simulator.js', 'tabs/simulator-intel.js',
    'engine.js',
